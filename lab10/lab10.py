...
with open('lab10/preproinsulin-seq-original.txt', 'r') as arquivo:
...
with open('lab10/lsinsulin-seq-clean.txt', 'w') as novo_arquivo:
...
with open('lab10/binsulin-seq-clean.txt', 'w') as novo_arquivo:
...
with open('lab10/cinsulin-seq-clean.txt', 'w') as novo_arquivo:
...
with open('lab10/ainsulin-seq-clean.txt', 'w') as novo_arquivo:
